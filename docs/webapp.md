...
Go to http://bioinf-ge001.cri.camres.org/

Apache is doing some forwarding to the pserve process, but there are problems that the links generated by Pyramid are all absolute and come up as "http://localhost:8080/...", which is a problem.
