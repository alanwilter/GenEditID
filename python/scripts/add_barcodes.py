...
df_variants = pd.read_csv('editid_variantid/variantid.csv')
df_koscores = pd.read_csv('editid_variantid/koscores.csv')
...
df_koscores = df_koscores[['plate_id','well','sample_id','amplicon_id','impact','impact_frequency']]
df_koscores.to_csv('editid_variantid/koscores_with_plate_location.csv', index=False)
