...
clone_growth_data <- fun.growth_readDB()
...
protein_abundance_data <- fun.protein_readDB() %>% fun.protein_calcratio()
...
NGS.positional_plot <- fun.NGS_plotindelranges(fun.NGS_indelranges())
